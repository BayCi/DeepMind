...
//  Hi,I'm Wait
//
//  Created by 妳的小可愛已上線 on 2019/10/18.
...
static CGFloat const rowheight = 25;//cell的高度
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //cell.textLabel.font = [UIFont systemFontOfSize:15.0f];//设置选项的文本大小
    cell.textLabel.textColor = [UIColor blackColor];//设置option的选项字体颜色
    cell.backgroundColor = [self colorWithHexString:@"FFF6E0" alpha:1.0f];//cell的背景色为自定义颜色
    return cell;
}
